...
% As part this dissertation, I have lead a series of  targeted, high-priority measurements of thin-target cross section, 
This dissertation  represents two extremes of cross section measurement for isotope production, as part of a larger campaign to address deficiencies in cross-cutting nuclear data needs. 
...
% a series of three  
two experiments, focusing on production pathways for the radionuclides \ce{^{90}Mo},  
% \ce{^{51}Mn}, \ce{^{52m}Mn}, \ce{^{52g}Mn}, 
\ce{^{64}Cu}, and \ce{^{47}Sc}.
...
The work described herein is the first step in an effort to characterize this reaction as a robust and reliable, contamination-free monitor reaction channel for 40--200\,MeV protons.
In addition, it illustrates the potential for  this 100\,MeV proton beam as a production pathway for multiple novel radionuclides.
...
This measurement additionally provides context for the utility of neutron generators for isotope production, as well as  introducing an efficiency quantification metric. 
...
Based on experience garnered from the LANSCE-IPF experiment, we have established a sister facility for measurements  at the Lawrence Berkeley National Laboratory's 88-Inch Cyclotron.
First experiments have already been performed, and one such measurement is briefly described here. 
...
One 
significant issue that was uncovered as a result of this work was the production of \ce{^{22,24}Na} as the proton beam traversed
% result of this work has been an increased appreciation for the role played by 
the acrylic adhesive on the Kapton tape used to contain the individual stacked targets in these measurements. 
...
% This contamination is frequently seen in 
Reactions on the silicone adhesive would occur in any  stacked-target activation experiments where adhesive-backed Kapton is used, and has the potential to systematically dampen the magnitude of reported cross sections by as much as 50\%. 
This issue is discussed as a cautionary note to future stacked-target cross section measurements.
