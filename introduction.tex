...
Most Auger emitters are commonly radionuclides which undergo electron capture decay, leading to the emission of a cascade of low-energy (10\,eV--10\,keV) Auger electrons and Coster-Kronig electrons \cite{adelstein1993merrill,Falzone2012}. 
...
Utilizing this data, production targets will be designed and tuned to match the beam energy for maximum high-purity radionuclide production. 
...
Chapter \ref{sec:chapter_ipf} is dedicated to describing the experimental measurement of the \ce{^{93}Nb}(p,4n)\ce{^{90}Mo} reaction as an intermediate-energy proton monitor.
...
Chapter \ref{sec:chapter_fe} is dedicated to describing the experimental measurement of the excitation function for production of the  \ce{^{nat}Fe}(p,x)\ce{^{51,52m,52g}Mn} novel PET isotopes.
...
Chapter \ref{sec:chapter_hfng} is dedicated to describing the experimental measurement of the \ce{^{64}Zn}, \ce{^{47}Ti}(n,p) cross sections.
