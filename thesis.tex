...
\title{Nuclear Excitation Functions for the Production of Novel Medical Radionuclides}
\author{Andrew Steven Voyles}
\degreesemester{Summer}
\degreeyear{2018}
\degree{Doctor of Philosophy}
% \chair{Adjunct Professor Lee  Bernstein}
\chair{Professor Lee  Bernstein}
% \othermembers{Professor Emeritus Joseph Cerny \\
\othermembers{Professor Rebecca Abergel\\
%   Assistant Professor Rebecca Abergel\\
  Professor Joseph Cerny\\
